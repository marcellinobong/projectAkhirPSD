<%@ Page Title="" Language="C#" MasterPageFile="~/View/Master.Master" AutoEventWireup="true" CodeBehind="InsertEmployee.aspx.cs" Inherits="NeinteenFlower.View.Employee.InsertEmployee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Calendar ID="CalendarDOB" SelectionMode="Day" SelectedDate="<%# (DateTime.Today.AddYears(-17)).AddDays(1) %>" runat="server"></asp:Calendar>
